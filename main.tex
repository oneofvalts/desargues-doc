...
\documentclass[fleqn, leqno, openright, oneside, 10pt]{memoir}
...
% \usepackage[math-style=french, bold-style=TeX]{fourier-otf}

\usepackage[math-style=french, bold-style=TeX]{unicode-math}

\setmainfont[Numbers=Lining]{Junicode}

\setmathfont{Garamond-Math.otf}[StylisticSet={2, 6, 8, 9}]
\setmathfont{Garamond-Math.otf}[range={scr,bfscr}]

\setmathfont[Numbers=Lining, range=it, Scale=MatchUppercase]{Junicode-Math.otf}[Path = /home/aby/junicode-math/]
\setmathfont[Numbers=Lining, range=up, Scale=MatchUppercase]{Junicode-Regular.otf}[Path = /home/aby/junicode-math/]
\setmathfont[Numbers=Lining, range=bfup, Scale=MatchUppercase]{Junicode Bold}

% \setmainfont{Bodoni 06pt Book}[
% BoldFont = Bodoni 06pt Medium,
% ItalicFont = Bodoni 06pt Book Italic,
% BoldItalicFont = Bodoni 06pt Medium Italic
% ]
...
% \setmainfont{Cooper}[%
% Path = /home/aby/.local/share/fonts/,
% UprightFont = Cooper-Regular.ttf,
...
% \setmathfont{Garamond-Math.otf}[Scale=MatchUppercase, StylisticSet={2, 6, 8, 9, 11}]

% \setmathfont{Garamond-Math.otf}[StylisticSet={2, 6, 8, 9}]
% \setmathfont{Garamond-Math.otf}[range={scr,bfscr}]

%\setmathfont[range=it]{Junicode Italic}
% \setmathfont[range=it, Scale=MatchUppercase]{Gentium Plus Italic}
% \setmathfont[range=it, Scale=MatchUppercase]{Junicode Italic}
% \setmathfont[range=up/num, Scale=MatchUppercase]{Junicode}
% \setmathfont[range=it, Scale=MatchUppercase]{Bodoni 06pt Book Italic}

% \setmathfont[range=it/{Greek, greek}, Scale=MatchUppercase]{Junicode Italic}
% \setmathfont[range=it/{Latin, latin}, Scale=MatchUppercase]{Cooper-Italic.otf}[Path = /home/aby/.local/share/fonts/]
% \setmathfont[range=up/num, Scale=MatchUppercase]{Cooper-Regular.ttf}[Path = /home/aby/.local/share/fonts/]

%\setmathrm{Garamond Libre}
%\setmathfont{STIX Two Math}[Scale=MatchUppercase]

% \setmainfont{KpRoman}[%
% Path = /usr/share/texmf-dist/fonts/opentype/public/kpfonts-otf/,
% UprightFont = KpRoman-Regular.otf,
% BoldtFont = KpRoman-Bold.otf,
...
\setmonofont[Scale=MatchLowercase]{Iosevka Etoile}
% \setmonofont[Scale=MatchLowercase]{Iosevka Fixed}
% \setmonofont[Scale=0.75]{Iosevka Fixed}
