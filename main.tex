% -*- TeX-engine: luatex; TeX-command-extra-options: "-shell-escape"; -*-
...
\null{}
\vfill{}
Ce document est composé avec \texttt{XeTeX} dans EB Garamond pour le corps du
texte, Garamond Math, pour les mathématiques et Iosevka pour le code source,
tous en 10pt.
