...
\setmathfont{TeX Gyre Pagella Math}
\setmonofont[Scale=0.75]{Iosvmata}
...
corps du texte et TeX Gyre Pagella Math pour les mathématiques, tous deux
en 10pt.
...
André Hernández-Espiet (Rutgers), Eric Wieser, Filippo A. E. Nuccio,
...
Lean a cette syntaxe où vous mettez la balise \mintinline{lean}{@[simp]}
